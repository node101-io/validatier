...
export function uatomToAtom(value: string | bigint | null | undefined, decimals: number): number {
  if (value === null || value === undefined) return 0;
  const uatom = typeof value === 'bigint' ? value : BigInt(value);
  return Number(uatom) / 10 ** decimals;
}

export function sumBigIntStrings(values: Array<string | null | undefined>): bigint {
