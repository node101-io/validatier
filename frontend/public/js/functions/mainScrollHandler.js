function mainScrollHandler() {
  ...
  allMainWrapper.addEventListener("scroll", (event) => {
    ...
    const scrollThreshold = window.innerWidth <= 500 ? 134 : 234;
    ...
    if (scrollTop < scrollThreshold) {
      ...
      selectedRange.style.background =
        "var(--selected-range-background-initial)";
      selectedRange.style.backdropFilter =
        "var(--selected-range-backdrop-filter-initial)";
      selectedRange.style.border =
        "var(--selected-range-border-size-initial) solid var(--selected-range-border-color-initial)";
      ...
      headerMainWrapper.style.background =
        "var(--header-main-background-initial)";
      datePicker.style.display = "var(--date-picker-display-initial)";

      pickerMainWrapper.style.border =
        "var(--picker-main-wrapper-border-size-initial) solid var(--general-main-wrapper-border-color)";
      pickerMainWrapper.style.borderTop = "none";

      headerBannerWrapper.style.height =
        "var(--header-banner-wrapper-height-initial)";
      headerBannerWrapper.style.marginLeft =
        "var(--header-banner-wrapper-margin-left-initial)";
      bannerTitle.style.marginTop =
        "var(--banner-title-content-margin-top-initial)";
      bannerTitle.style.fontSize =
        "var(--banner-title-content-font-size-initial)";
    } else {
      ...
      selectedRange.style.backdropFilter =
        "var(--selected-range-backdrop-filter)";
      selectedRange.style.border =
      ...
      pickerMainWrapper.style.border =
        "var(--picker-main-wrapper-border-size) solid var(--general-main-wrapper-border-color)";
      pickerMainWrapper.style.borderTop = "none";
  ...
  const mobileMenuStartWrapper = document.getElementById(
    "mobile-menu-start-wrapper"
  );
  const mobileMenuDescriptionWrapper = document.getElementById(
    "mobile-menu-description-wrapper"
  );
  ...
  startButton?.addEventListener("click", (event) => {
    ...
    document.querySelectorAll(".falling-star").forEach((eachFallingStar) => {
      ...
      eachFallingStar.querySelector(".falling-star-star").style.animation =
        "spin 2s linear infinite";
      eachFallingStar.querySelector(".falling-star-trail").style.transform =
        "translate(-90px, -90px)";
    });
