...
import CacheSummaryGraph from '../../models/CacheSummaryGraph/CacheSummaryGraph.js';
  ...
  Chain.getAllChains((err, chains) => {
    ...
    async.times(
      ...
      (i, next) => {
        ...
        CacheSummaryGraph.saveCacheSummaryGraphForChain({ chain: eachChain }, (err, cacheSummaryGraph) => {
